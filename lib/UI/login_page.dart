...
import 'package:shopping_zone/style/bubble_indication_painter.dart';
              ...
              children: <Widget>[
                Padding(
                  ...
                  child: new Image(
                      ...
                      height: 191.0,
                      fit: BoxFit.fill,
                      image: new AssetImage('images/logotipo.png')),
                ),
                Padding(
  ...
  onSignUp() async {
    ...
    try {
      ...
      if (userId.length > 0 && userId != Null) {
        // _showDialog("SignUp successfull");
      ...
      // print('Error: $e');
      // _showDialog("Went's wrong");
      showInSnackBar("Went's wrong");
    }
  }
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: MaterialButton(
                    ...
                    onPressed: () =>
                        onLogIn()), //showInSnackBar("Login button pressed")),
              ),
            ],
          ),
          Padding(
